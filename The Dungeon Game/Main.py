...
class Game:
    ...
    def start_cs(self):
        ...
        self.draw_text("OH CRAP!!! I'm late for Kiremire class", self.title_font, 22, RED, WIDTH / 3.7, HEIGHT / 2)
    ...
    def start_es(self):
        ...
        self.draw_text("It's Thursday... I'm a freakin' idiot", self.title_font, 22, RED, WIDTH / 3.7, HEIGHT / 1.5)
        pg.display.flip()
        self.wait_for_key()
