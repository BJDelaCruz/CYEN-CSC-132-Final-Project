...
class Game:
    ...
    def load_data(self):
        ...
        self.playerd_img = [pg.transform.scale(item, (TILESIZE-12, TILESIZE-12)) for item in self.playerd_img]
        self.playeru_img = [pg.transform.scale(item, (TILESIZE-12, TILESIZE-12)) for item in self.playeru_img]
        self.playerl_img = [pg.transform.scale(item, (TILESIZE-12, TILESIZE-12)) for item in self.playerl_img]
        self.playerr_img = [pg.transform.scale(item, (TILESIZE-12, TILESIZE-12)) for item in self.playerr_img]
    ...
    def new(self):
        ...
        # Sets the Map
        self.map = TiledMap(path.join(self.map_folder, 'FinalMapTest.tmx'))
